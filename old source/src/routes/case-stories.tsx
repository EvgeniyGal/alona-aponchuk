...
export const Route = createFileRoute("/case-stories")({
  head: () => ({
    meta: [
      { title: "Case Stories — Selected Workflow Engagements | Alona Aponchuk" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Selected Case Stories — Aponchuk Workflow Systems" },
      {
      ...
      { property: "og:url", content: "/case-stories" },
    ],
    links: [{ rel: "canonical", href: "/case-stories" }],
  }),
  component: Page,
});
