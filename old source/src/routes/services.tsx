...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Services — Aponchuk Workflow Systems" },
      { property: "og:description", content: "Bounded consulting engagements calibrated to your operational context." },
      ...
      <Section>
        <div className="grid gap-6 md:grid-cols-2 items-stretch">
          {services.map((s) => (
            <article
              key={s.title}
              className="rounded-2xl border border-hairline bg-white p-8 md:p-10 flex flex-col h-full min-h-[440px] transition-all hover:border-blue/40 hover:shadow-md"
            >
