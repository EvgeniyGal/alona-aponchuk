...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Request a Workflow Audit" },
      { property: "og:description", content: "Diagnostic consulting form for healthcare and wellness organizations across the United States." },
