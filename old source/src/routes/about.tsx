...
import portrait from "@/assets/alona-portrait.jpg.asset.json";
...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About Alona Aponchuk" },
      { property: "og:description", content: "Executive consulting profile — CRM, patient management, workflow reliability, and responsible AI." },
