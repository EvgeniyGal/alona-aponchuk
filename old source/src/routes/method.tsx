...
export const Route = createFileRoute("/method")({
  head: () => ({
    meta: [
      { title: "My Method — Workflow Discovery to Controlled Pilot | Alona Aponchuk" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "My Method — Structured Workflow Optimization" },
      { property: "og:description", content: "Seven structured steps from discovery to controlled pilot." },
