...
export const Route = createFileRoute("/research")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Research Basis — Aponchuk Workflow Systems" },
      { property: "og:description", content: "Applied research supporting reliable AI-mediated communication in healthcare and wellness workflows." },
  ...
  return (
    <>
      ...
      <Section>
        ...
        {/* Desktop: horizontal, no overflow */}
        <div className="mt-12 hidden md:grid grid-cols-6 gap-3 items-stretch">
          {layers.map((l, i) => (
            <div key={l.code} className="relative flex">
              <div className="w-full rounded-xl border border-hairline bg-white p-4 lg:p-5 flex flex-col">
        ...
        {/* Mobile: vertical connected workflow */}
      ...
      <Section className="bg-white border-y border-hairline">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          {metrics.map((m) => (
            <div key={m.code} className="rounded-2xl border border-hairline p-8 bg-ivory/60">
              <div className="w-14 h-14 rounded-lg bg-teal-soft text-teal flex items-center justify-center font-display font-semibold">
                {m.code}
              </div>
      ...
      <Section>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2">
          {publications.map((p) => (
            <article key={p.doi} className="rounded-2xl border border-hairline bg-white p-8">
