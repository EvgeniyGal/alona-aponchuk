...
export const Route = createFileRoute("/responsible-ai")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Responsible AI in Healthcare & Wellness Workflows" },
      { property: "og:description", content: "AI belongs in the operational layer of the client journey, not in place of professional judgment." },
      { property: "og:url", content: "/responsible-ai" },
    ],
    links: [{ rel: "canonical", href: "/responsible-ai" }],
  }),
  component: Page,
});
